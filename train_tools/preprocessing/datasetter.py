...
__all__ = ["data_distributer", 'DATA_LOADERS']
...
def data_distributer(
    ...
    if partition.method == 'if_01':
        data_path = os.path.join('data', dataset_name,
                                 f'if_01_alpha_{partition.data_alpha}_'
                                 f'data_distributed.pick')
    elif partition.method == 'if_001':
        data_path = os.path.join('data', dataset_name,
                                 f'if_001_alpha_{partition.data_alpha}_'
                                 f'data_distributed.pick')
    elif partition.method == 'if_002':
        data_path = os.path.join('data', dataset_name,
                                 f'if_002_alpha_{partition.data_alpha}_'
                                 f'data_distributed.pick')
    else:
        raise NotImplementedError('')
    with open(data_path, 'rb') as f:
        data_distributed = pickle.load(f)
    ...
    logging.info(">>> Distributing client train data...")
    ...
    logging.info(">>> Distributing client test data...")
